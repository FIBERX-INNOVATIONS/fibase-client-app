...
| Identity / Wallet / Transaction  | [identity_wallet_transaction.md](./ui_flows/identity_wallet_transaction.md)           | [Identity](./content_payloads/samples/identity_view_content_sample.json), [Wallet](./content_payloads/samples/wallet_view_content_sample.json), [Transaction](./content_payloads/samples/transaction_view_content_sample.json) |
