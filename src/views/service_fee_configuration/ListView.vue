<template>
    <section id="ServiceFeeConfigurationListView" :class="list_view_class_styles?.wrapper_class_style">
...
import ServiceFeeConfigurationListViewController from "@/controllers/service_fee_configuration/list_view_controller";

const props = defineProps<ListViewPropsInterface>();

const controller = new ServiceFeeConfigurationListViewController(props);
