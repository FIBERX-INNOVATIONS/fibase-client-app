<template>
    <section
        id="PaymentProviderMethodListView"
...
import PaymentProviderMethodListViewController from "@/controllers/payment_provider_method/list_view_controller";
import type { ListViewPropsInterface } from "@/ui_types/list_view_type";

const props = defineProps<ListViewPropsInterface>();
const controller = new PaymentProviderMethodListViewController(props);
