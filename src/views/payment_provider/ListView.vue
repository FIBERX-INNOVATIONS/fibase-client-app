<template>
    <section id="PaymentProviderListView" :class="list_view_class_styles?.wrapper_class_style">
...
import PaymentProviderListViewController from "@/controllers/payment_provider/list_view_controller";
import type { ListViewPropsInterface } from "@/ui_types/list_view_type";

const props = defineProps<ListViewPropsInterface>();
const controller = new PaymentProviderListViewController(props);
