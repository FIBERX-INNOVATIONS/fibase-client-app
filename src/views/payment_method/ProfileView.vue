    ...
    <div v-else :class="class_styles.wrapper_class_style">
        ...
        <div :class="class_styles.grid_class_style?.two_col_responsive_grid_wrapper_class_style">
            <div :class="class_styles.grid_class_style?.grid_wrapper_class_style">
                ...
                <ProfileValue
                    ...
                    :value="state_refs.profile_record.value?.metadata?.display_name || content_obj.empty_value_text"
                />

                <ProfileValue
                    icon="numbered_list_svg_icon"
                    :label="content_obj.display_group_label_text"
                    :value="state_refs.profile_record.value?.metadata?.display_group || content_obj.empty_value_text"
                />

                <ProfileValue
                    icon="clock_svg_icon"
                    :label="content_obj.processing_time_label_text"
                    :value="state_refs.profile_record.value?.metadata?.processing_time_text || content_obj.empty_value_text"
                />

                <ProfileValue
                    icon="dollar_currency_svg_icon"
                    :label="content_obj.fee_label_text"
                    :value="state_refs.profile_record.value?.metadata?.fee_label || content_obj.empty_value_text"
                />
            </div>
            ...
            <div :class="class_styles.grid_class_style?.grid_wrapper_class_style">
                ...
                <ProfileValue
                    ...
                    :value="state_refs.profile_record.value?.metadata?.min_amount ?? content_obj.empty_value_text"
                />

                <ProfileValue
                    icon="dollar_currency_svg_icon"
                    :label="content_obj.max_amount_label_text"
                    :value="state_refs.profile_record.value?.metadata?.max_amount ?? content_obj.empty_value_text"
                />
            </div>
        </div>
        ...
        <div :class="class_styles.grid_class_style?.two_col_responsive_grid_wrapper_class_style">
            ...
            <div :class="class_styles.grid_class_style?.grid_wrapper_class_style">
                ...
                <ProfileValue
                    ...
                    :value="state_refs.profile_record.value?.sort_order ?? content_obj.empty_value_text"
                />
        ...
        <div :class="class_styles.grid_class_style?.two_col_responsive_grid_wrapper_class_style">
            <div :class="class_styles.grid_class_style?.grid_wrapper_class_style">
                ...
                <div
                    v-if="state_refs.profile_record.value?.metadata?.supported_country_codes?.length"
                    :class="class_styles.role_chip_wrapper_class_style"
                >
                    <span
                        v-for="code in state_refs.profile_record.value.metadata.supported_country_codes"
                        :key="code"
            ...
            <div :class="class_styles.grid_class_style?.grid_wrapper_class_style">
                ...
                <div
                    v-if="state_refs.profile_record.value?.metadata?.supported_currency_codes?.length"
                    :class="class_styles.role_chip_wrapper_class_style"
                >
                    <span
                        v-for="code in state_refs.profile_record.value.metadata.supported_currency_codes"
                        :key="code"
                        :class="class_styles.role_chip_class_style"
                    >
                        {{ code }}
