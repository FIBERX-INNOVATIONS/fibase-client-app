<template>
    <section id="PaymentMethodListView" :class="list_view_class_styles?.wrapper_class_style">
...
import PaymentMethodListViewController from "@/controllers/payment_method/list_view_controller";
import type { ListViewPropsInterface } from "@/ui_types/list_view_type";

const props = defineProps<ListViewPropsInterface>();
const controller = new PaymentMethodListViewController(props);
