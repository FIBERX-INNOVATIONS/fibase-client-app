<template>
    <section id="TransactionListView" :class="list_view_class_styles.wrapper_class_style">
...
import TransactionListViewController from "@/controllers/transaction/list_view_controller";

const props = defineProps<ListViewPropsInterface>();

const controller = new TransactionListViewController(props);
