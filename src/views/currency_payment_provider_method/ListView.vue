<template>
    <section
        id="CurrencyPaymentProviderMethodListView"
        :class="list_view_class_styles?.wrapper_class_style"
    >
...
import CurrencyPaymentProviderMethodListViewController from "@/controllers/currency_payment_provider_method/list_view_controller";
import type { ListViewPropsInterface } from "@/ui_types/list_view_type";

const props = defineProps<ListViewPropsInterface>();
const controller = new CurrencyPaymentProviderMethodListViewController(props);
