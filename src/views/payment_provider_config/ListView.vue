<template>
    <section
        id="PaymentProviderConfigListView"
...
import PaymentProviderConfigListViewController from "@/controllers/payment_provider_config/list_view_controller";
import type { ListViewPropsInterface } from "@/ui_types/list_view_type";

const props = defineProps<ListViewPropsInterface>();
const controller = new PaymentProviderConfigListViewController(props);
