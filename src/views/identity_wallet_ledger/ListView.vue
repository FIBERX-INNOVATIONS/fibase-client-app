<template>
    <section id="IdentityWalletLedgerListView" :class="list_view_class_styles.wrapper_class_style">
...
import IdentityWalletLedgerListViewProps from "@/props_definition/identity_wallet_ledger/list_view_props";

import IdentityWalletLedgerListViewController from "@/controllers/identity_wallet_ledger/list_view_controller";

const props = defineProps(IdentityWalletLedgerListViewProps);
const controller = new IdentityWalletLedgerListViewController(props);
