<template>
    <section id="AppWebhookDeliveryListView" :class="list_view_class_styles.wrapper_class_style">
...
import AppWebhookDeliveryListViewController from "@/controllers/app_webhook_delivery/list_view_controller";

const props = defineProps<ListViewPropsInterface>();

const controller = new AppWebhookDeliveryListViewController(props);
