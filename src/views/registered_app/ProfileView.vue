        ...
        <div v-else :class="class_styles.wrapper_class_style">
            ...
            <div :class="class_styles.grid_class_style?.two_col_responsive_grid_wrapper_class_style">
                <div :class="class_styles.grid_class_style?.grid_wrapper_class_style">
                    ...
                    <p :class="class_styles.small_bold_value_text_class_style">
                        <span 
                            v-html="getSVGIconValue(state_refs?.profile_record?.value?.is_active ? 'check_circle_svg_icon' : 'x_circile_svg_icon')"
                            :class="[class_styles.icon_class_style, state_refs?.profile_record?.value?.is_active ? 'text-green-400' : 'text-red-400']"
                        ></span>
            ...
            <div :class="class_styles.grid_class_style?.two_col_responsive_grid_wrapper_class_style">
                ...
                <div :class="class_styles.grid_class_style?.grid_wrapper_class_style">
                    ...
                    <div v-if="state_refs?.profile_record?.value?.creator" class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 :class="class_styles.member_name_class_style">{{ getMemberFullName(state_refs?.profile_record?.value?.creator) }}</h3>
                            <p :class="class_styles.description_class_style">{{ state_refs?.profile_record?.value?.creator.email }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div :class="class_styles.grid_class_style?.grid_wrapper_class_style">
                    ...
                    <div v-if="state_refs?.profile_record?.value?.updater" class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 :class="class_styles.member_name_class_style">{{ getMemberFullName(state_refs?.profile_record?.value?.updater) }}</h3>
                            <p :class="class_styles.description_class_style">{{ state_refs?.profile_record?.value?.updater.email }}</p>
                        </div>
                    </div>
                </div>
            </div>
