...
const FilePreviewUploadUIClassStyles: FilePreviewUploadUIClassStylesInterface = {
    ...
    preview_container_class_style:
        "w-full h-auto md:max-h-[500px] max-h-[700px] overflow-y-auto overflow-x-hidden",

    file_item_wrapper_class_style:
        "relative p-2 w-full h-[200px] flex items-center justify-center rounded-md p-[3%]",

    remove_file_btn_content_class_style: "",

    remove_btn_wrapper_class_style:
        "absolute top-1 right-4 w-10 h-10 flex items-center p-1 justify-center rounded-full bg-gray-300 hover:shadow-lg cursor-pointer",

    remove_btn_loader_class_style:
    ...
    bottom_action_wrapper_class_style:
        "w-full border-t flex items-center justify-center gap-4 py-2 px-4",
