...
const CancelButtonUIClassStyles: ButtonUIClassStylesInterface = {
    ...
    button_class_style: "w-full cursor-pointer inline-flex mt-4 items-center justify-center rounded-lg ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 h-10 px-4 bg-gradient-to-r from-gray-200 to-gray-400 hover:from-gray-300 hover:to-gray-200 disabled:from-gray-300 disabled:to-gray-400 disabled:text-gray-600 disabled:cursor-not-allowed text-md text-gray-800 font-semibold tracking-wider py-3",
