...
class LoginViewController extends BaseController<
    ...
    GlobalEventTypes
> {
    public action_handler: LoginViewActionHandler;
    ...
    constructor(props: LoginViewPropsInterface) {
        ...
        this.action_handler = new LoginViewActionHandler(this);
    ...
    protected getUIStateData(): LoginViewStateDataInterface {
        ...
        const user_name_input_props = InputUIPropsBuilder.getReactivePropsObject(
            "username",
            "text",
            username_content_key
        );

        const password_input_props = InputUIPropsBuilder.getReactivePropsObject(
            "password",
            "password",
        ...
        return {
            header_text_props: HeaderTextUIPropsBuilder.getReactivePropsObject(
                "h2",
                "content_resource.login_view_ui.header_text"
            ),

            username_input_group_props: InputGroupUIPropsBuilder.getReactivePropsObject(
                user_name_input_props,
                username_content_key
            ),

            password_input_group_props: InputGroupUIPropsBuilder.getReactivePropsObject(
