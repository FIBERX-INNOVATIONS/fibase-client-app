...
class CurrencyProfileViewController extends BaseProfileViewController<CurrencyRecordInterface> {
    ...
    protected getChildProfileViewContentKeys(): Partial<CurrencyProfileViewContentKeysInterface> {
        ...
        return {
            ...
            network_label_text: `${base_content_key}.sections.currency_information.network_label_text`,
            network_symbol_label_text: `${base_content_key}.sections.currency_information.network_symbol_label_text`,
            token_standard_label_text: `${base_content_key}.sections.currency_information.token_standard_label_text`,
    ...
    protected getProfileViewContentFallbacks(): Partial<CurrencyProfileViewContentTextInterface> {
        return {
            ...
            network_label_text: "Network:",
            network_symbol_label_text: "Network Symbol:",
            token_standard_label_text: "Token Standard:",
