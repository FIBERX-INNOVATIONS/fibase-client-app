...
> {
    ...
    protected getUIStateData(): AppCurrencyFormState {
        ...
        const currency_list             = currency_codes.map(((code: string): SelectOptionInterface => { return { label_text: code, value: code }}));
        ...
        ToasterUIPropsBuilder.configure("assign_currency_submit_toaster", toaster_ui_class_styles, toaster_action_config);
        ...
        return {
            ...
            btn_props: ButtonUIPropsBuilder.getReactivePropsObject("app_currency_submit", btn_content_key, "paper_airplane_send_svg_icon")
