...
> {
    ...
    protected buildFormFieldsUI(): CurrencyFieldsType {
        ...
        return {
            ...
            symbol_input_group_props: this.buildInputGroupProps(
                "symbol",
                "text",
                field_content_key("symbol"),
            ...
            precision_input_group_props: this.buildInputGroupProps(
                "precision",
                "number",
                field_content_key("precision"),
                { model_value: record?.precision ?? "" }
            ),

            minor_unit_input_group_props: this.buildInputGroupProps(
                "minor_unit",
                "number",
                field_content_key("minor_unit"),
            ...
            is_fiat_input_group_props: this.buildInputGroupProps(
                "is_fiat",
                "checkbox",
                field_content_key("is_fiat"),
                {
